    ...
    */
    {
        ...
        mainWaves: [
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 15,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runts, multiplier: 2.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 15,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsMedics, multiplier: 2.0 }
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.bruisers, multiplier: 2.0 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.bruisersMedics, multiplier: 2.0 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsBruisers, multiplier: 2.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineers, multiplier: 4.0 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineersMedics, multiplier: 4.0 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineersGrunters, multiplier: 4.0 }
                    }
                ]
            }
        ],
        ...
        recurringWaves: [
            ...
            {
                groups: 2,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersEngineers, multiplier: 4 }
            }
        ],
        overtimeSetup: {
            minimumCount: 30,
        ...
        mainWaves: [
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grunters, multiplier: 2.5 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersMedics, multiplier: 2.5 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersEngineers, multiplier: 2.5 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 15,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.bruisers, multiplier: 2.5 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 15,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.bruisersMedics, multiplier: 2.5 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 15,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersBruisers, multiplier: 2.5 }
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                variations: [
                    {
                        groups: 3,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersEngineers, multiplier: 6.0 }
                    },
                    {
                        groups: 3,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineers, multiplier: 6.0 }
                    },
                    {
                        groups: 3,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineersMedics, multiplier: 6.0 }
                    }
                ]
            }
        ],
        ...
        recurringWaves: [
            {
                groups: 2,
                nextWaveTime: 40,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grunters, multiplier: 3.0 }
            },
            {
                groups: 2,
                nextWaveTime: 40,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersMedics, multiplier: 3.0 }
            },
            {
                groups: 2,
                nextWaveTime: 40,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersEngineers, multiplier: 3.0 }
            }
        ],
        overtimeSetup: {
            minimumCount: 35,
    ...
    */
    {
        ...
        mainWaves: [
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineers, multiplier: 5.0 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineersGrunters, multiplier: 5.0 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineersMedics, multiplier: 5.0 }
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.bruisers, multiplier: 3 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.bruisersEngineers, multiplier: 3 }
                    },
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.bruisersGrunters, multiplier: 3 }
                    }
                ]
            },
            {
        ...
        recurringWaves: [
            {
                groups: 2,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineers, multiplier: 4.2 }
            },
            {
                groups: 2,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.engineersBruisers, multiplier: 4.2 }
            }
        ],
        overtimeSetup: {
            minimumCount: 40,
