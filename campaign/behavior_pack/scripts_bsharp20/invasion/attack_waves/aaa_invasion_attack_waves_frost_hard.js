...
const invasionAttackV2_frostWaveDefinitions_hard = {
...
groups: 1,
unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.(unitGroup), multiplier: (number) }
B.
nextWaveTime (optional): (number),
groups: (number)),
units: [
...
// eslint-disable-next-line @typescript-eslint/camelcase, @typescript-eslint/no-unused-vars
const invasionAttackV2_waveConfig_frostFaction_hard = [
    /*
    --------------------
    ---- STRENGTH 1 ----
    --------------------
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runts, multiplier: 3 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsMedics, multiplier: 3 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runts, multiplier: 6 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsMedics, multiplier: 6 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsSeekers, multiplier: 6 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grunters, multiplier: 6 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersMedics, multiplier: 6 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersPigatroopers, multiplier: 2 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.pigatroopers, multiplier: 1 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grenadiersMedics, multiplier: 2 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
            ...
            },
            {
                ...
                variations: [
                    ...
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grenadiersMedics, multiplier: 1 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersPigatroopers, multiplier: 1 }
                    }
                ]
            }
        ],
        ...
        recurringWaves: [
            {
                groups: 2,
                nextWaveTime: 10,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grunters, multiplier: 4 }
            },
            {
                groups: 2,
                nextWaveTime: 10,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersMedics, multiplier: 4 }
            },
            {
                groups: 2,
                nextWaveTime: 10,
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grunters, multiplier: 3.5 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                    ...
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersMedics, multiplier: 3.5 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersSeekers, multiplier: 2.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.pigatroopersSeekers, multiplier: 2.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersLavaLauncher, multiplier: 1.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grenadiersLavaLauncher, multiplier: 1.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grenadiersGruntersLavaLauncer, multiplier: 1.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    ...
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersSeekers, multiplier: 2 }
                    }
                ]
            }
        ],
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.pigatroopers, multiplier: 3.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                    ...
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersPigatroopers, multiplier: 2.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    ...
                    },
                    {
                        groups: 1,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.seekersLavaLauncher, multiplier: 1.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grunters, multiplier: 2.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 1,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.lotsOfGruntersGrenadiers, multiplier: 2.0 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersMedicsGrenadiers, multiplier: 2.0 }
                    }
                ]
            }
        ],
        ...
        recurringWaves: [
            {
                groups: 2,
                nextWaveTime: 24,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grenadiersGrunters, multiplier: 2.0 }
            },
            {
                groups: 2,
                nextWaveTime: 24,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.grenadiersMedics, multiplier: 2.0 }
            },
            {
                groups: 2,
                nextWaveTime: 24,
    ...
    */
    {
        ...
        mainWaves: [
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsSeekers, multiplier: 3.7 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersWarboars, multiplier: 3.7 }
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                variations: [
                    {
                        groups: 3,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsWarboars, multiplier: 3.7 }
                    },
                    {
                        groups: 3,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsWarboarsMedics, multiplier: 3.7 }
                    }
                ]
            },
            {
        ...
        recurringWaves: [
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsSeekers, multiplier: 4.3 }
            },
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.gruntersWarboars, multiplier: 4.3 }
            },
            {
                groups: 3,
                units: [
            ...
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsWarboars, multiplier: 4.3 }
            },
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_hard.runtsWarboarsMedics, multiplier: 4.3 }
            },
            {
                groups: 3,
                units: [
...
RegisterDifficultyConfig("invasion_attack_wave_config_frost_faction", invasionAttackV2_waveConfig_frostFaction_hard, GAME_DIFFICULTY.hard)
