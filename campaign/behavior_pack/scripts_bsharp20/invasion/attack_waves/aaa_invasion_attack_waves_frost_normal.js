...
const invasionAttackV2_frostWaveDefinitions_normal = {
...
groups: 1,
unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.(unitGroup), multiplier: (number) }
B.
nextWaveTime (optional): (number),
groups: (number)),
units: [
...
// eslint-disable-next-line @typescript-eslint/camelcase, @typescript-eslint/no-unused-vars
const invasionAttackV2_waveConfig_frostFaction_normal = [
    /*
    --------------------
    ---- STRENGTH 1 ----
    --------------------
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runts, multiplier: 3 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsMedics, multiplier: 3 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runts, multiplier: 6 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsMedics, multiplier: 6 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsSeekers, multiplier: 6 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grunters, multiplier: 6 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersMedics, multiplier: 6 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersPigatroopers, multiplier: 2 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.pigatroopers, multiplier: 1 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grenadiersMedics, multiplier: 2 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
            ...
            },
            {
                ...
                variations: [
                    ...
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grenadiersMedics, multiplier: 1 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersPigatroopers, multiplier: 1 }
                    }
                ]
            }
        ],
        ...
        recurringWaves: [
            {
                groups: 2,
                nextWaveTime: 10,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grunters, multiplier: 4 }
            },
            {
                groups: 2,
                nextWaveTime: 10,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersMedics, multiplier: 4 }
            },
            {
                groups: 2,
                nextWaveTime: 10,
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grunters, multiplier: 3.5 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 10,
                    ...
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersMedics, multiplier: 3.5 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersSeekers, multiplier: 2.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.pigatroopersSeekers, multiplier: 2.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersLavaLauncher, multiplier: 1.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grenadiersLavaLauncher, multiplier: 1.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grenadiersGruntersLavaLauncer, multiplier: 1.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    ...
                    },
                    {
                        groups: 1,
                        nextWaveTime: 10,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersSeekers, multiplier: 2 }
                    }
                ]
            }
        ],
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.pigatroopers, multiplier: 3.0 }
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                    ...
                    },
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersPigatroopers, multiplier: 2.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    ...
                    },
                    {
                        groups: 1,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.seekersLavaLauncher, multiplier: 1.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grunters, multiplier: 2.0 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 1,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.lotsOfGruntersGrenadiers, multiplier: 2.0 }
                    },
                    {
                        groups: 1,
                        nextWaveTime: 24,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersMedicsGrenadiers, multiplier: 2.0 }
                    }
                ]
            }
        ],
        ...
        recurringWaves: [
            {
                groups: 2,
                nextWaveTime: 24,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grenadiersGrunters, multiplier: 2.0 }
            },
            {
                groups: 2,
                nextWaveTime: 24,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.grenadiersMedics, multiplier: 2.0 }
            },
            {
                groups: 2,
                nextWaveTime: 24,
    ...
    */
    {
        ...
        mainWaves: [
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsSeekers, multiplier: 3.7 }
                    }
                ]
            },
            {
                ...
                variations: [
                    {
                        groups: 2,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersWarboars, multiplier: 3.7 }
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                variations: [
                    {
                        groups: 3,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsWarboars, multiplier: 3.7 }
                    },
                    {
                        groups: 3,
                        unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsWarboarsMedics, multiplier: 3.7 }
                    }
                ]
            },
            {
        ...
        recurringWaves: [
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsSeekers, multiplier: 4.3 }
            },
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.gruntersWarboars, multiplier: 4.3 }
            },
            {
                groups: 3,
                units: [
            ...
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsWarboars, multiplier: 4.3 }
            },
            {
                groups: 3,
                unitPreset: { preset: invasionAttackV2_frostWaveDefinitions_normal.runtsWarboarsMedics, multiplier: 4.3 }
            },
            {
                groups: 3,
                units: [
...
RegisterDifficultyConfig("invasion_attack_wave_config_frost_faction", invasionAttackV2_waveConfig_frostFaction_normal, GAME_DIFFICULTY.normal)
RegisterDifficultyConfig("invasion_attack_wave_config_frost_faction", invasionAttackV2_waveConfig_frostFaction_normal, GAME_DIFFICULTY.custom)
