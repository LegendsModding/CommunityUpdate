...
RegisterDifficultyConfig("horde_bases_setup_config", HordeBasesSetup, GAME_DIFFICULTY.easy, true)
RegisterDifficultyConfig("horde_entry_config", HordeEntryConfig, GAME_DIFFICULTY.easy)