  ...
  if (get(MAP_KEY.INVASION_SPECIAL) === MAP_INVASION_SPECIAL.IS_BOSS) {
    ...
    switch (get(MAP_KEY.ATTACKING_FACTION)) {
      ...
      case MAP_FACTION_IDS.FACTION_OBSTACLE:
        ...
        break;
      case MAP_FACTION_IDS.FACTION_FROST:
        makeEntity(ICON_GROUP.ATTACK_BANNER, ATTACK_BANNER.FROST_BANNER);
        break;
    }
    ...
    case MAP_MOB_ALLEGIANCE.DISABLED:
      switch (mobAlliance) {
        ...
        case MAP_FACTION_IDS.MOB_ALLIANCE_SPIDER:
          makeEntity(
            ICON_GROUP.MOB_ALLIANCE_EXTENDED_TOOLTIP,
            MAP_EXTENDED_TOOLTIP.MOB_ALLEGIANCE_LOST_SPIDER
          );
          makeEntity(
            ICON_GROUP.VO_TOOLTIP,
...
const addCultureMainTooltip = () => {
  ...
  switch (get(MAP_KEY.ACT1_VILLAGE_STATE)) {
    case MAP_ICON_STATE.UNDER_ATTACK:
      switch(get(MAP_CATEGORY.FACTION)) {
        case MAP_FACTION_IDS.CULTURE_FOREST:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL01_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_FROSTLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL02_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_DRYLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL03_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_WETLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL04_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_GRASSLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL05_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_BROKENLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL06_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_FATEFUL_LAND:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL07_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_JUNGLE:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL08_OCCUPIED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_MOUNTAIN:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL09_OCCUPIED_TOOLTIP);
          return;
      }
    case MAP_ICON_STATE.TARGETED:
    case MAP_ICON_STATE.TARGTED_VA_ACT1:
      switch(get(MAP_CATEGORY.FACTION)) {
        case MAP_FACTION_IDS.CULTURE_FOREST:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL01_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_FROSTLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL02_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_DRYLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL03_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_WETLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL04_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_GRASSLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL05_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_BROKENLANDS:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL06_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_FATEFUL_LAND:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL07_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_JUNGLE:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL08_TARGETED_TOOLTIP);
          return;
        case MAP_FACTION_IDS.CULTURE_MOUNTAIN:
          makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL09_TARGETED_TOOLTIP);
          return;
      }
  }
  ...
  if(!canFastTravel() && !isPlayerOutpost()) {
    switch(get(MAP_CATEGORY.FACTION)) {
      case MAP_FACTION_IDS.CULTURE_FOREST:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL01_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_FROSTLANDS:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL02_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_DRYLANDS:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL03_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_WETLANDS:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL04_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_GRASSLANDS:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL05_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_BROKENLANDS:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL06_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_FATEFUL_LAND:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL07_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_JUNGLE:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL08_NEW_TOOLTIP);
        return;
      case MAP_FACTION_IDS.CULTURE_MOUNTAIN:
        makeEntity(ICON_GROUP.DESCRIPTION, MAP_DESCRIPTION_IDS.VILLAGE_CUL09_NEW_TOOLTIP);
        return;
  ...
  if (iconSpawned) {
    switch (factionName) {
      ...
      case MAP_FACTION_IDS.FACTION_OBSTACLE:
        ...
        break;
      case MAP_FACTION_IDS.FACTION_FROST:
        presentation(ICON_GROUP.MAIN_ICON, MAP_PRESENTATION.FACTION_FROST);
        break;
      case MAP_FACTION_IDS.FACTION_DBB:
...
const displayClaimedAreaIcon = () => {
  ...
  switch (horde) {
    ...
    case MAP_FACTION_IDS.FACTION_OBSTACLE:
      ...
      break;
    case MAP_FACTION_IDS.FACTION_FROST:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.CLAIMED_AREA_FROST);
      break;
  }
...
onUpdate(() => {
  ...
  switch (get(MAP_CATEGORY.FACTION)) {
    ...
    case MAP_FACTION_IDS.FACTION_OBSTACLE:
      ...
      break;
    case MAP_FACTION_IDS.FACTION_FROST:
      displayPiglinFactionIcon(MAP_FACTION_IDS.FACTION_FROST);
      addSizeTooltip();
      addBaseLootTooltipParameters();
      break;
    case MAP_FACTION_IDS.FACTION_DBB:
    ...
    case MAP_FACTION_IDS.MOB_ALLIANCE_SKELETON:
      ...
      break;
    case MAP_FACTION_IDS.MOB_ALLIANCE_SPIDER:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.MOB_ALLIANCE_SPIDER);
      displayInvasionStateIcon();
      displayMobAllianceStateIcon();
    ...
    case MAP_FACTION_IDS.TOWER_04:
      ...
      break;
    case MAP_FACTION_IDS.TOWER_05:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.TOWER_05);
      break;
    case MAP_FACTION_IDS.TOWER_06:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.TOWER_06);
      break;
    ...
    case MAP_FACTION_IDS.ALLY_05:
      ...
      break;
    case MAP_FACTION_IDS.ALLY_06:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.ALLY_06);
      break;
    case MAP_FACTION_IDS.ALLY_07:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.ALLY_07);
      break;
    case MAP_FACTION_IDS.LEGEND_01:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.LEGEND_01);
      break;
    case MAP_FACTION_IDS.LEGEND_02:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.LEGEND_02);
      break;
    ...
    case MAP_FACTION_IDS.MOUNT_06:
      ...
      break;
    case MAP_FACTION_IDS.MOUNT_07:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.MOUNT_07);
      break;
    case MAP_FACTION_IDS.MOUNT_08:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.MOUNT_08);
      break;
    case MAP_FACTION_IDS.MOUNT_09:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.MOUNT_09);
      break;
  ...
  switch (buildableCategory) {
    ...
    case MAP_BUILDABLE_IDS.TOWER_04:
      ...
      displayTeamIdentifierPip();
      break;
    case MAP_BUILDABLE_IDS.TOWER_05:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.TOWER_05);
      displayTeamIdentifier();
      displayTeamIdentifierPip();
      break;
    case MAP_BUILDABLE_IDS.TOWER_06:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.TOWER_06);
      displayTeamIdentifier();
      displayTeamIdentifierPip();
      break;
  ...
  switch (get(MAP_CATEGORY.MOB)) {
    ...
    case MAP_MOB_IDS.ALLY_05:
      ...
      displayTeamIdentifierPip();
      break;
    case MAP_MOB_IDS.ALLY_06:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.ALLY_06);
      displayTeamIdentifier();
      displayTeamIdentifierPip();
      break;
    case MAP_MOB_IDS.ALLY_07:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.ALLY_07);
      displayTeamIdentifier();
      displayTeamIdentifierPip();
      break;
    case MAP_MOB_IDS.LEGEND_01:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.LEGEND_01);
      displayTeamIdentifier();
      displayTeamIdentifierPip();
      break;
    case MAP_MOB_IDS.LEGEND_02:
      makeEntity(ICON_GROUP.MAIN_ICON, MAP_ICON.LEGEND_02);
      displayTeamIdentifier();
      displayTeamIdentifierPip();
      break;
