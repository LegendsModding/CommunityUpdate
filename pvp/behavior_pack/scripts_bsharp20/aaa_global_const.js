...
const FACTION_PIGLINS = [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE]
const HORDE_PIGLINS_ALL = [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE, FACTION_NAME_DBB, FACTION_NAME_WOF]
const FACTION_PIGLINS_ALL = [FACTION_NAME_ATTACK, FACTION_NAME_DEFEND, FACTION_NAME_OBSTACLE, FACTION_NAME_DBB, FACTION_NAME_WOF]
...
const FACTION_POI_TOWERS = [POI_TOWER_NAME_KNOCKBACK, POI_TOWER_NAME_FREEZE, POI_TOWER_NAME_STUN]
...
const FACTION_POI_MOUNTS = [POI_NAME_MOUNT_01, POI_NAME_MOUNT_03, POI_NAME_MOUNT_04, POI_NAME_MOUNT_06]
...
const FACTION_POI_ALLIES = [POI_NAME_ALLY_01, POI_NAME_ALLY_02, POI_NAME_ALLY_04, POI_NAME_ALLY_05]

const FACTION_POI_ALL = [POI_TOWER_NAME_KNOCKBACK, POI_TOWER_NAME_FREEZE, POI_TOWER_NAME_STUN, POI_NAME_MOUNT_01, POI_NAME_MOUNT_03, POI_NAME_MOUNT_04, POI_NAME_MOUNT_06, POI_NAME_ALLY_01, POI_NAME_ALLY_02, POI_NAME_ALLY_04, POI_NAME_ALLY_05]

const MOB_ALLIANCE_IDS = ["creeper", "skeleton", "zombie"]
...
const BASE_SIZE_ALL_PORTALS_AND_BOSS_AND_MOB = [BASE_SIZE_SMALL, BASE_SIZE_MEDIUM, BASE_SIZE_LARGE, BASE_SIZE_BOSS, BASE_SIZE_PIGLIN_CREEPER, BASE_SIZE_PIGLIN_SKELETON, BASE_SIZE_PIGLIN_ZOMBIE]
