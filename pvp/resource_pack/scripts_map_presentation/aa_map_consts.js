...
const MAP_BUILDABLE_IDS = {
  ...
  ALLAY_KILLER: "tower_allay_killer",
  PVP_HQ: "pvp_hq",
...
//OTHER
const INVISIBLE_BASE_SIZES = [MAP_BASE_SIZE.OCCUPYING_CREEPER, MAP_BASE_SIZE.OCCUPYING_SKELETON, MAP_BASE_SIZE.OCCUPYING_ZOMBIE, MAP_BASE_SIZE.FOB_SMALL, MAP_BASE_SIZE.FOB_MEDIUM, MAP_BASE_SIZE.FOB_LARGE];
